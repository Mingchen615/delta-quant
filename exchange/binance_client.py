...
class BinanceClient:
    ...
    async def fetch_markets(self) -> List[Dict]:
        """获取交易对信息"""
        return await self._rate_limited(self.exchange.fetch_markets)
    ...
    async def fetch_tickers(self, symbols: Optional[List[str]] = None) -> Dict[str, Dict]:
        """获取多个交易对行情"""
        return await self._rate_limited(self.exchange.fetch_tickers, symbols)
    ...
    async def fetch_order_book(
        ...
        """获取订单簿"""
        return await self._rate_limited(self.exchange.fetch_order_book, symbol, limit)
    ...
    async def fetch_agg_trades(
        ...
        """获取聚合成交"""
        return await self._rate_limited(self.exchange.fetch_agg_trades, symbol, None, limit)
    ...
    async def fetch_positions(self, symbol: Optional[str] = None) -> List[Dict]:
        ...
        positions = await self._rate_limited(self.exchange.fetch_positions)
    ...
    async def fetch_funding_rate(self, symbol: str) -> Dict:
        """获取资金费率"""
        return await self._rate_limited(self.exchange.fetch_funding_rate, symbol)
